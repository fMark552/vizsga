...
var QueryClient = class {
  ...
  mount() {
    ...
    if (__privateGet(this, _mountCount) !== 1)
      return;
    __privateSet(this, _unsubscribeFocus, import_focusManager.focusManager.subscribe((focused) => {
      if (focused) {
        this.resumePausedMutations();
        __privateGet(this, _queryCache).onFocus();
      }
    }));
    __privateSet(this, _unsubscribeOnline, import_onlineManager.onlineManager.subscribe((online) => {
      if (online) {
        this.resumePausedMutations();
